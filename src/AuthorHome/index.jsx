...
import {MenuUnfoldOutlined, MenuFoldOutlined,FormOutlined,UnorderedListOutlined,FireOutlined} from '@ant-design/icons';
        ...
        return (
            <Layout>
                ...
                <Layout className="site-layout" >
                    ...
                    <Content className="site-layout-concent" style={{margin: '24px 16px', padding: 24,}}>
                        <Switch>
